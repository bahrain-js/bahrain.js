...
<template>
  <section
    ref="pipelineRef"
    class="py-12 sm:py-16 md:py-20 bg-elevated relative z-10 overflow-hidden"
  >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 relative">
        ...
        >
          <UIcon
            ...
            class="size-5 text-primary bg-default rounded-full p-0.5 z-10"
          />
        </div>
        ...
        >
          ...
          <div
            ...
            class="lg:hidden w-full flex justify-center -mb-2 -mt-2"
          >
            <UIcon
